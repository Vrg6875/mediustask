...
#for student modelviewsets
router = DefaultRouter()
router.register(r'student_data', StudentViewSet, basename='student_data')

#for todo odelviewset
router = DefaultRouter()
router.register(r'todo_data', todoViewSet, basename='todo_data')

router = DefaultRouter()
router.register(r'company', companyViewSet, basename='company_data')
