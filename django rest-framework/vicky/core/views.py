...
class studentapi(APIView):
  ...
  def put(self,request):
    try: 
      data=request.data
      student_obj=student.objects.get(id=request.data['id'])# here also use id=request.data.get('id)
...
#modelviewset ek url se sara call hoga (get,del,put,patch)
...
#yha se ek hi url s sab kaam hoga isme id,uid url me hi pass krnegetab hi usko pata lagega ki kaun sa method 
